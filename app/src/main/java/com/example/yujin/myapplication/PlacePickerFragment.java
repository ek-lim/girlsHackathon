...
public class PlacePickerFragment extends Fragment implements OnCardClickListener {
    ...
    SettongLocation settongLocation;
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PlacePickerFragment = PlacePickerFragment.this;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PLACE_PICKER) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                final String aa = String.valueOf(place.getLatLng());
                ...
                SettongLocation pp = (SettongLocation) SettongLocation.PublicMap;
                pp.finish();
            } else {
